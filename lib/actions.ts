...
const openai = new OpenAI({
  baseURL: "https://api.deepseek.com", // DeepSeek's API URL
  apiKey: process.env.DEEPSEEK_API_KEY, // Add this to your .env file
});
...
export async function fetchAndSummarizeFeed(feeds: Feed[]) {
  try {
    ...
    const validFeeds = feedsData.filter(
